...
var Me = [],
    ...
    K = (e, t) => {
        if (
            (e !== void 0 && t !== void 0 && Me.push([e, t]), !Oe && Me.length)
        ) {
            let n = Re(Me);
            ((Me.length = 0),
    ...
    _ = (e, { ifMissing: t } = {}) => {
        M();
        for (let n in e)
            e[n] == null ? t || delete ne[n] : Tt(e[n], n, ne, "", t);
        x();
    },
    A = (e, t) => _(Re(e), t),
    Tt = (e, t, n, r, s) => {
    ...
    Ee = (e, t, n = !0) =>
        V({
            ...
            apply: async (
                ...
                let Y =
                    m instanceof AbortController ? m : new AbortController();
                ((m === "auto" || m === "cleanup") &&
                ...
                try {
                    if (!a?.length)
                        throw i("FetchNoUrlProvided", { action: V });
                    let fe = {
                    ...
                    let q = Object.assign({}, fe, l),
                        N = {
                            ...
                            onopen: async (y) => {
                                y.status >= 400 &&
                                    re(fn, r, { status: y.status.toString() });
                            },
                            onmessage: (y) => {
...
`),
                            ...
                            onerror: (y) => {
                                if (Ct(y))
                                    throw y("FetchExpectedTextEventStream", {
                                        url: a,
                                    });
                                y &&
                                    (console.error(y.message),
                                    re(dn, r, { message: y.message }));
                            },
                        },
                        Ve = () => {
                            ...
                            if (u === "json") {
                                ...
                                let D = new FormData(E),
                                    F = r;
                                if (r === E && s instanceof SubmitEvent)
                                    F = s.submitter;
                                else {
                                ...
                                if (t === "GET")
                                    for (let [w, de] of O) U.append(w, de);
                ...
                D = async () => {
                    ...
                    try {
                        ...
                        if (Ie?.includes("text/javascript")) {
                            ...
                            if (me)
                                for (let [De, Ae] of Object.entries(
                                    JSON.parse(me),
                                ))
    ...
    apply({ el: e, mods: t, rx: n }) {
        ...
        let i = t.has("exit"),
            o = new IntersectionObserver((a) => {
                for (let c of a)
                    c.isIntersecting !== i &&
                        (r(), o && st.has(e) && o.disconnect());
            }, s);
        return (
            o.observe(e),
            t.has("once") && st.add(e),
            () => {
                (t.has("once") || st.delete(e),
...
var Ut = (e) => {
        ...
        for (let n of t)
            if (!ot.has(n)) {
                ...
                for (let { name: s, value: i } of n.attributes)
                    r.setAttribute(s, i);
